		...
		<div className="wrapper text-dark-background">
			...
			{/*<p>
				...
				<a href="http://www.material-ui.com/" target="_blank">
					<span className='icon-material-ui'>
						<span className="path1"></span>
						<span className="path2"></span>
						<span className="path3"></span>
						<span className="path4"></span>
				...
				<a href="https://www.rethinkdb.com/" target="_blank">
					<span className='icon-rethinkdb'>
					</span>
				</a>
			</p>
			<p>
				Find me at: &nbsp;&nbsp;&nbsp;&nbsp;
				<a href="https://github.com/rob-feng-wellington/rivl-redux-react-new" target="_blank">
					<span className='icon-github-icon-1'>
					</span>
				</a>
				&nbsp;&nbsp;|&nbsp;&nbsp;
				<a href="https://cn.linkedin.com/in/rob-feng-a5632b40" target="_blank">
